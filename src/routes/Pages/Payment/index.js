...
export default function VerticalTabs() {
  ...
  return (
    <div className={classes.root}>
      <SmallTitleBar
        title={<IntlMessages id="components.paymentGateways" />}
        center={true}
      />
      <Container>
        <Box px={{ xs: "12px", lg: 0 }}>
            ...
            <CustomCard cardClasses="border-t border-l border-r">
              <Box mb={1}>
                <Typography variant="h5">
                  <IntlMessages id="components.connectPaymentGateways" />
                </Typography>
              </Box>
              ...
              >
                <Tab
                  style={{
                    backgroundImage:
                      "url(" +
                      require("assets/Images/stripe-sm.png").default +
                      ")",
                    backgroundSize: "85%",
                ...
                <Tab
                  style={{
                    backgroundImage:
                      "url(" +
                      require("assets/Images/paypal-sm.png").default +
                      ")",
                    backgroundSize: "82%	",
                    backgroundPosition: "center center",
                  }}
