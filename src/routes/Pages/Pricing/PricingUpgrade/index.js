            ...
            <Grid container direction="row">
                    ...
                    <Stepper activeStep={activeStep} orientation="vertical">
                        ...
                        <StepLabel>
                          <Box my={2}>
                            <Typography variant="h6">
                              <IntlMessages id="component.chooseYourPlan" />
                            </Typography>
                          </Box>
                        </StepLabel>
                                  ...
                                  <Box className="pack-content">
                                    ...
                                    >
                                      <Box>
                                        ...
                                        <Box>
                                          <Typography>$1/per month</Typography>
                                        </Box>
                                      </Box>
                                      <Box>
                                        <i className="material-icons">
                      ...
                      <Step>
                        <StepLabel>
                          <Box my={1}>
                            <Typography variant="h6">
                              <IntlMessages id="component.addYourDebitCreditCard" />
                            </Typography>
                          </Box>
                        </StepLabel>
                        <StepContent className="stepper-content">
                      ...
                      <Step>
                        <StepLabel>
                          <Box my={1}>
                            <Typography variant="h6">
                              <IntlMessages id="component.termsandconditions" />
                            </Typography>
                          </Box>
                        </StepLabel>
                        <StepContent className="stepper-content">
              ...
              <Grid item xs={12} sm={2} className="md-hide">
                <Box className="update-img-wrap">
                  <img
                    src={require("assets/Images/update-plan.png").default}
                    alt="site logo"
                    width="474"
                    height="559"
                ...
                <Grid container spacing={3} direction="row">
                  <Grid item xs={12} sm={12}>
                    <Box bgcolor="primary.main" className="sideline"></Box>
                  </Grid>
                </Grid>
              </Grid>
            </Grid>
