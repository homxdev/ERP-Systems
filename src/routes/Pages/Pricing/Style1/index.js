...
function Style1() {
  ...
  return (
    <div className="pricing-wrapper">
      <SmallTitleBar
        title={<IntlMessages id="component.chooseYourPlan" />}
        center={true}
        desc="Choose any below plan and take your business to next level"
      />
        ...
        <Container>
          <Box px={{ xs: "12px", lg: 0 }}>
            <Box className="price-list">
              ...
              >
                <Box component="span">
                  <IntlMessages id="component.monthly" />
                </Box>
                <Box px={2} lineHeight={1}>
                  <Switch
                    onClick={() => onPlanChange(monthlyPlan)}
                    on={monthlyPlan}
                  />
                </Box>
                <Box component="span">
                  <IntlMessages id="component.yearly" />
                </Box>
              </Box>
            </Box>
          </Box>
                ...
                <div className="text-center">
                  <div className="contact-us-item">
                    <div className="contact-us--icon">
                      <i
                        className="fa fa-phone transform-icon font-xl"
                        aria-hidden="true"
                      ></i>
                    </div>
                    <div className="contact-us--content mt-1">
                      <Typography variant="h5">
                        <IntlMessages id="component.callUsAnyTime" />
                      </Typography>
                      <Typography className="mt-1" variant="body2">
                        <a className="text-disabled" href="# ">
                          +0123 45678 90
                        </a>
                      </Typography>
              ...
              <Grid item xs={12} sm={12} md={3}>
                <div className="text-center">
                  <div className="contact-us-item">
                    <div className="contact-us--icon">
                      <i
                        className="fa fa fa-envelope-o font-xl"
                        aria-hidden="true"
                      ></i>
                    </div>
                    <div className="contact-us--content mt-1">
                      <Typography variant="h5">
                        <IntlMessages id="component.dropUsALine" />
                      </Typography>
                      <Typography className="mt-1 text-over" variant="body2">
                        <a
                      ...
                      <Typography variant="body2" className="text-over">
                        <a
                          href="mailto:support@theironnetwork.org"
                          className="text-disabled"
                        >
